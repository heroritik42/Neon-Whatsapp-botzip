...
console.log(`Neon-AI ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+916205232179'; // Replace this with the actual owner number
        const ownerName = 'Neon-Coder'; // Replace this with the owner's name
        const organization = 'Hacker Attitude'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+916205232179', '') + '+916205232179@s.whatsapp.net'], // Mention the owner
